...
const MOCK_OFFERS: UpstreamOffer[] = [
  {
    ...
    vertical: "health",
    description: "Sample pediatric dental practice — $50 lead bounty per consult.",
  ...
  },
  {
    ...
    title: "Spring Hair Refresh — Sample Salon Bundle",
    brand: "Bloom Salon",
    vertical: "beauty",
    description: "Sample salon promo. Pays per booked appointment.",
